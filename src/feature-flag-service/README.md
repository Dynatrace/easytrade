...
| `ergo_aggregator_slowdown` | `false` | When enabled, the Offer Service will respond with a delay to 2 out of 5 AggregatorServices, causing those services to pause queries for 1 hour. |
