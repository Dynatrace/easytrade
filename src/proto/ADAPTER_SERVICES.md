...
|---|---|---|---|
| **AccountService** | 6 | 1. CreateAccount 2. GetAccountById 3. GetAccountByUsername 4. GetAccounts 5. UpdateAccount 6. DeleteAccountsOlderThan | Account, Login, Manager, Content-Creator |
