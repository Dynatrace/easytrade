...
export default function QuickSellForm() {
    ...
    const possessedAmount = instrument.amount
    ...
    const { mutate, isPending } = useMutation({
        mutationFn: async (): Promise<void> => {
            ...
            if (amount > possessedAmount) throw "Can't sell more assets than possessed"
    ...
    return (
        <form className="form" onSubmit={handleSubmit} style={{ minWidth: 280 }}>
            ...
            <div className="form-group">
                <label className="form-label" htmlFor="possessedAmount">Possessed amount</label>
                <input id="possessedAmount" type="number" value={possessedAmount} readOnly />
            </div>
            <div className="form-group">
