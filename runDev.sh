...
case $1 in
    "start")
        docker compose -f $COMPOSE_FILE up --detach frontendreverseproxy background-service
    ;;
    "stop")
    ...
    ;;
    "start-load")
        docker compose -f $COMPOSE_FILE up --detach frontendreverseproxy background-service loadgen
    ;;
    "start-all")
